...
public class DynamicController {
	...
	public Map<String, Object> getdynamic(HttpServletRequest req,getdynamicArgs getdynamic){
		ArrayList<Map<String, String>> u = loginServiceImpl.searchDynamic(getdynamic);
		result<ArrayList<Map<String, String>>> restult = new result<ArrayList<Map<String, String>>>(u, 0,0);
