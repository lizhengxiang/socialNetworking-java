...
import com.g7love.services.dynamicService;
...
public class dynamicServiceimpl implements dynamicService{
     ...
     */
	public ArrayList<Map<String, String>> searchDynamic(getdynamicArgs getdynamic) {
		ArrayList<Map<String, String>> result =  um.getDynamic(getdynamic);
		/*
		...
		for (int i = 0; i < len; i++) {
			//System.out.println(result.get(i).get("createtime"));
			try  
			{  
